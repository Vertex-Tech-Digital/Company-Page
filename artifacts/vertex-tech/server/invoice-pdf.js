...
function getCompany() {
  ...
  return {
    ...
    email: env.INVOICE_EMAIL || "vertextechcontact@gmail.com",
    bcc: env.INVOICE_BCC || "vertextechcontact@gmail.com",
  };
}
...
/* ── i18n ES/EN ─────────────────────────────────────────────────────────────── */
const LABELS = {
  es: { invoice: "FACTURA", number: "Nº de factura", issueDate: "Fecha de emisión", dueDate: "Fecha de vencimiento", billedTo: "Facturar a", nif: "NIF/CIF", description: "Descripción", quantity: "Cant.", unitPrice: "Precio unit.", lineTotal: "Importe", subtotal: "Base imponible", tax: "IGIC", total: "Total", notes: "Notas", iae: "Epígrafe IAE", locale: "es-ES" },
  en: { invoice: "INVOICE", number: "Invoice no.", issueDate: "Issue date", dueDate: "Due date", billedTo: "Billed to", nif: "Tax ID", description: "Description", quantity: "Qty", unitPrice: "Unit price", lineTotal: "Amount", subtotal: "Subtotal", tax: "IGIC", total: "Total", notes: "Notes", iae: "Business activity code", locale: "en-GB" },
};
