...
const companyTaxId =
  import.meta.env.VITE_COMPANY_TAX_ID || "[Identificación Fiscal / Tax ID]";
const companyHolder =
  import.meta.env.VITE_COMPANY_HOLDER || "[Titular Legal / Legal Holder]";
const contactEmail =
  import.meta.env.VITE_CONTACT_EMAIL || "[Correo de Contacto / Contact Email]";
