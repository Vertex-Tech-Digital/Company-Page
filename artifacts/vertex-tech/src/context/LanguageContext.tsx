...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    // Hero
    "hero.subheadline":
      "Consultoría tecnológica y soluciones a medida: automatizamos procesos, integramos sistemas y auditamos tu software para que tu empresa funcione más rápido, con menos errores y a menor coste.",
    ...
    "services.3.title":
      "Automatización Inteligente e Integración de Procesos (IA)",
    "services.3.desc":
      "Optimizamos las operaciones de tu empresa eliminando tareas manuales repetitivas. Diseñamos e integramos flujos de trabajo automatizados, conectores de APIs avanzados, pasarelas de pago seguras (Stripe/Bizum), sistemas de mensajería automatizada por WhatsApp y soluciones de Inteligencia Artificial para reducir costes y multiplicar la eficiencia de tu equipo.",
    // Projects
    "projects.title": "Proyectos Destacados",
    "projects.subtitle":
      "Una muestra del tipo de soluciones de software que desarrollamos y auditamos para nuestros clientes",
    "projects.0.title": "Plataformas de Gestión Empresarial y RRHH (SaaS)",
    "projects.0.desc":
      "Desarrollo de ecosistemas internos en la nube para la administración masiva de activos y personal con arquitectura reactiva.",
    "projects.1.title": "Dashboards y Analítica en Tiempo Real",
    "projects.1.desc":
      "Paneles de control optimizados para el procesamiento de datos a gran escala y visualización de métricas críticas de negocio.",
    "projects.2.title": "Automatización e Integración de Sistemas",
    "projects.2.desc":
      "Migración de software heredado a infraestructuras API modernas y adaptadas para entornos móviles.",
    // Methodology
    ...
    "methodology.0.desc":
      "Definición de requisitos y diseño de la arquitectura técnica.",
    "methodology.1.title": "Desarrollo Ágil por Hitos",
    "methodology.1.desc":
      "Entregas funcionales constantes y código revisado en GitHub.",
    "methodology.2.title": "Control de Calidad Riguroso",
    "methodology.2.desc":
      "Pruebas integrales (QA Testing) para garantizar robustez.",
    "methodology.3.title": "Despliegue Continuo y Soporte",
    "methodology.3.desc":
      "Subida a la nube en servidores optimizados y mantenimiento técnico.",
    // WhyUs
    ...
    "contact.subtitle":
      "Cuéntanos qué necesitamos y te ayudamos a diseñar e implementar la solución tecnológica a medida que tu empresa requiere.",
    ...
    "footer.copyright":
      "2026 Vertex Tech Digital. Todos los derechos reservados.",
    ...
    "footer.legal.body":
      "En cumplimiento del artículo 10 de la Ley 34/2002 (LSSI-CE), se informa que este sitio web es una plataforma de presentación comercial operada provisionalmente por su fundador, ***REMOVED***, con identificación fiscal Y8259024Z y residencia en Tenerife, Canarias, España. Para cualquier consulta o comunicación, puede dirigirse al correo electrónico oficial de contacto: vertextechcontact@gmail.com.",
  ...
  en: {
    ...
    // Hero
    "hero.subheadline":
      "Technology consulting and custom solutions: we automate your processes, integrate your systems and audit your software — so your business runs faster, with fewer errors and at lower cost.",
    ...
    "services.0.desc":
      "We don't build static websites; we design and develop powerful business software that runs through the internet. We build everything from internal platforms to manage your clients, sales, and staff in real time, to intelligent dashboards to automate your company's processes.",
    "services.1.title": "High-Performance APIs & Systems Integration",
    "services.1.desc":
      "We connect your systems with any third-party service securely. We develop efficient API architectures with Node.js and NestJS, enabling real-time data synchronization, payment gateways, and automations.",
    "services.2.title": "Quality Engineering, QA & Testing",
    "services.2.desc":
      "We protect the stability of your software. We implement rigorous quality control cycles, automated testing, and code audits before deployment to ensure your platform works flawlessly from day one.",
    "services.3.title": "Smart Automation & AI Process Integration",
    "services.3.desc":
      "We optimize your company's operations by eliminating repetitive manual tasks. We design and integrate automated workflows, advanced API connectors, secure payment gateways (Stripe/Bizum), automated WhatsApp messaging systems, and Artificial Intelligence solutions to reduce costs and multiply your team's efficiency.",
    // Projects
    "projects.title": "Featured Projects",
    "projects.subtitle":
      "A sample of the software solutions we develop and audit for our clients",
    "projects.0.title": "Enterprise Management & HR Platforms (SaaS)",
    "projects.0.desc":
      "Development of cloud-based internal ecosystems for large-scale asset and personnel management with reactive architecture.",
    "projects.1.title": "Real-Time Dashboards & Analytics",
    "projects.1.desc":
      "Control panels optimized for large-scale data processing and critical business metrics visualization.",
    "projects.2.title": "Systems Automation & Integration",
    "projects.2.desc":
      "Migration of legacy software to modern API infrastructures adapted for mobile environments.",
    // Methodology
    "methodology.title": "Our Methodology",
    "methodology.desc":
      "At Vertex Tech we work with an agile, results-oriented methodology. We divide each project into clear stages, prioritize constant communication, rigorous quality control, and on-time deliveries. Our goal is not just to build software, but to create stable, maintainable, and scalable solutions.",
    "methodology.0.title": "Analysis & Strategy",
    "methodology.0.desc":
      "Requirements definition and technical architecture design.",
    "methodology.1.title": "Agile Milestone Development",
    "methodology.1.desc":
      "Constant functional deliveries and code reviewed on GitHub.",
    "methodology.2.title": "Rigorous Quality Control",
    "methodology.2.desc":
      "Comprehensive testing (QA Testing) to ensure robustness.",
    "methodology.3.title": "Continuous Deployment & Support",
    "methodology.3.desc":
      "Cloud deployment on optimized servers and ongoing technical maintenance.",
    // WhyUs
    ...
    "contact.subtitle":
      "Tell us what you need and we'll help you design and implement the custom tech solution your business deserves.",
    ...
    "footer.legal.body":
      "In compliance with Article 10 of Law 34/2002 (LSSI-CE), please be advised that this website is a commercial presentation platform provisionally operated by its founder, ***REMOVED***, with tax identification number Y8259024Z, residing in Tenerife, Canary Islands, Spain. For any inquiries, please reach out to our official contact email: vertextechcontact@gmail.com.",
    ...
    "whatsapp.message":
      "Hello, I'd like to get more information about your services.",
  },
};
