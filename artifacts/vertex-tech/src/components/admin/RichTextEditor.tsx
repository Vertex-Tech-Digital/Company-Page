...
export function RichTextEditor({
  ...
  // https:// solo cuando hace falta — se deja tal cual si la URL ya trae un
  // esquema explícito (http:, https:, mailto:, tel:, sms:, etc.), o si es
  // una ruta relativa ("/docs"), un ancla interna ("#seccion") o una URL
  // protocol-relative ("//cdn.ejemplo.com/x").
